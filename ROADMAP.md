...
| **Dashboard `Silk HQ — Meraki`** | **recibiendo datos desde 2026-09-22** por la pata de API. Faltan syslog y webhooks, que son config del lado Meraki | el informe asumía org `Silk Technologies` y red `Silk HQ`: **ninguna existe**. Real: org `Silk-Technologies` id 610420 (la key ve 4 orgs, 2 de otros clientes), redes `Silk Lab` e `Itinerante`. Detalle: `robot-splunk-docs/INTEGRACION-MERAKI.md` |
